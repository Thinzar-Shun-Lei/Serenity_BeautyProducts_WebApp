...
{
    $txtPositionName = $_POST['txtPositionName'];
    $rdoStatus = $_POST['rdoStatus'];

// Position already exist check
    $query = "SELECT * FROM Positions WHERE PositionName = '$txtPositionName'";
    $ret = mysqli_query($connection,$query);
    $count = mysqli_num_rows($ret);
    if($count>0) {
        echo "<script>window.alert('The Position already exists.')</script>";
        echo "<script>window.location = 'Positions.php' </script>";
    }
    else {
        $Insert = "INSERT INTO Positions(PositionName, PositionStatus)
                VALUES ('$txtPositionName','$rdoStatus')";
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <title>Staff Position Entry</title>
</head>
...
<body>
    ...
    <div class="sideMain">
            ...
            <div class="sideContent">
                ...
                <div class="sideMenu">
                    <ul style="width: 100%; padding: 0;">
                        ...
                        <hr class="hrSide" width="100%">
                        <li class="sideMenuLi">
                            <a class="sideMenuActive" href="Positions.php">Positions</a>
                        </li>
                        <hr class="hrSide" width="100%">
                        <li class="sideMenuLi">
        ...
        <div class="contentContainer">
            <form action="Positions.php" method="post" class="positionForm">
                <h2>Entry form : <span style="color:#f797a5"> Positions</span></h2>
                <div class="inputContainer">
                    <div class="inputGroup">
                        <label for="">Position Name <span style="color: red;">*</span></label> <br>
                        <input type="text" name="txtPositionName" placeholder="eg., Manager" required>
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Position Status <span style="color: red;">*</span></label> <br>
            ...
            <!-- Disply 2 -->
            <h2 class="tblHeader">Position Information</h2>
            <div class="displayList">
                <table>
                    <?php
                    $roleQuery = "SELECT * FROM Positions";
                ...
                ?>
                    ...
                    ?>
                        <tr class="tdGroup">
                            ...
                            <td><?php echo $positionStatus ?></td>
                            <td>
                                <a href='Positions_Edit.php?PositionID=<?php echo $positionID ?>'> Edit </a> |
                                <a href='Positions_Delete.php?PositionID=<?php echo $positionID ?>'> Delete </a>
                            </td>
                        </tr>
