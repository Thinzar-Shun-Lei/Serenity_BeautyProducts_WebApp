...
<body>
    ...
    <div class="sideMain">
        ...
        <div class="contentContainer">
            <form action="Categories_Edit.php" method="post" class="positionForm">
                <h2>Update Form : <span style="color:#f797a5"> Categories</span></h2>
                <div class="inputContainer">
                    <div class="inputGroup">
                        <label for="">Category Name <span style="color: red;">*</span></label> <br>
                        <input type="text" name="txtCategoryName" value="<?php echo $row['CategoryName'] ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
            ...
            ?>
                    ...
                    <br><br>
                    <input type="hidden" name="txtCategoryID" value="<?php echo $row['CategoryID'] ?>" /><br><br>
