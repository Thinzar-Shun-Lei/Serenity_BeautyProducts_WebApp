...
<body>
    ...
    <div class="sideMain">
        ...
        <div class="contentContainer">
            <h2 class="purchaseDetails">Purchase Details Information</h2><br><br>
                    ...
                    <table class="tblInfo">
                        ...
                        <?php
                            if (isset($_REQUEST['PurchaseID'])) {
                                ...
                                $select = "SELECT *
                                           FROM Purchases p, Products pr, PurchaseDetails pd, Brands b, Categories c
                                           WHERE p.PurchaseID = pd.PurchaseID
                                           AND pr.ProductID = pd.ProductID
                                           AND pr.BrandID = b.BrandID
                                           AND pr.CategoryID = c.CategoryID
