...
if(isset($_POST['btnUpdate'])) 
{
	...
	$Update="UPDATE Suppliers
			 ...
			 SupplierEmail='$txtSupplierEmail',
			 SupplierPhone='$txtSupplierPhone',
			 SupplierAddress='$txtSupplierAddress'
	...
	{
		echo "<p>Something went wrong in Supplier Update : " . mysqli_error($connection) . "</p>";
	}
}
...
// get position name from Session PositionID
...
<body>
    ...
    <div class="sideMain">
        ...
        <div class="contentContainer">
            <form action="Suppliers_Edit.php" method="post" class="positionForm">
                <h2>Update Form : <span style="color:#f797a5"> Suppliers</span></h2>
                <div class="inputContainer">
                    <div class="inputGroup">
                        <label for="">Supplier Name </label> <br>
                        <input type="text" name="txtSupplierName" value="<?php echo $row['SupplierName'] ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Supplier Email</label> <br>
                        <input type="text" name="txtSupplierEmail" value="<?php echo $row['SupplierEmail'] ?>">
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Supplier Phone</label> <br>
                        <input type="text" name="txtSupplierPhone" value="<?php echo $row['SupplierPhone'] ?>">
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Supplier Address</label> <br>
                        <input type="text" name="txtSupplierAddress" value="<?php echo $row['SupplierAddress'] ?>">
                    </div>
                    <br><br>

                    <input type="hidden" name="txtSupplierID" value="<?php echo $row['SupplierID'] ?>" /><br><br>
