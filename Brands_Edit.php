...
if(isset($_POST['btnUpdate'])) 
{
	...
	{
		echo "<p>Something went wrong in Brand Update : " . mysqli_error($connection) . "</p>";
	}
}
...
<body>
    ...
    <div class="sideMain">
        ...
        <div class="contentContainer">
            <form action="Brands_Edit.php" method="post" class="positionForm">
                <h2>Update Form : <span style="color:#f797a5"> Brands</span></h2>
                <div class="inputContainer">
                    <div class="inputGroup">
                        <label for="">Brand Name <span style="color: red;">*</span></label> <br>
                        <input type="text" name="txtBrandName" value="<?php echo $row['BrandName'] ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
            ...
            ?>
                    ...
                    <br><br>
                    <input type="hidden" name="txtBrandID" value="<?php echo $row['BrandID'] ?>" /><br><br>
