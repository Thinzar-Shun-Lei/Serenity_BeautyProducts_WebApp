...
if(isset($_POST['btnUpdate'])) 
{
	...
	$Update="UPDATE Positions
			 ...
			 PositionStatus='$rdoStatus' 
			 WHERE 
			 PositionID='$txtPositionID'
			 ";
	...
	{
		echo "<p>Something went wrong in Position Update : " . mysqli_error($connection) . "</p>";
	}
}
...
<body>
    ...
    <div class="sideMain">
        ...
        <div class="contentContainer">
            <form action="Positions_Edit.php" method="post" class="positionForm">
                <h2>Update Form : <span style="color:#f797a5"> Positions</span></h2>
                <div class="inputContainer">
                    <div class="inputGroup">
                        <label for="">Position Name
                            <!-- <span style="color: red;">*</span>-->
                        </label> <br>
                        <input type="text" name="txtPositionName" value="<?php echo $row['PositionName'] ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
