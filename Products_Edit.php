...
if(isset($_POST['btnUpdate'])) 
{
    ...
    $cboBrandName =$_POST['cboBrandName'];
    $cboCategoryName =$_POST['cboCategoryName'];
    $txtMD = $_POST['txtMD'];
    $txtED = $_POST['txtED'];
	...
	$Update="UPDATE Products
             ...
             BrandID = '$cboBrandName',
             CategoryID = '$cboCategoryName',
             ManufacturedDate = '$txtMD',
             ExpiredDate = '$txtED',
	...
	{
		echo "<p>Something went wrong in Product Update : " . mysqli_error($connection) . "</p>";
	}
}
...
$dproductID = $row['ProductID'];
$dMD = $row['ManufacturedDate'];
$dED = $row['ExpiredDate'];
$dQty = $row['Quantity'];
$dPPrice = $row['PurchasePrice'];
$dSPrice = $row['SellPrice'];
$dProfit = $row['Profit'];
$dDescription = $row['Description'];
$dProductStatus = $row['ProductStatus'];

$SelectBrand = "SELECT * FROM Brands WHERE BrandID = '$selectedBrand'";
$retBrand = mysqli_query($connection,$SelectBrand);
$rowBrand = mysqli_fetch_array($retBrand);

$SelectCat = "SELECT * FROM Categories WHERE CategoryID = '$selectedCat'";
$retCat = mysqli_query($connection,$SelectCat);
$rowCat = mysqli_fetch_array($retCat);
...
<body>
    ...
    <div class="sideMain">
        ...
        <div class="contentContainer">
            <form action="Products_Edit.php" method="post" class="positionForm">
                <h2>Update Form : <span style="color:#f797a5"> Products</span></h2>
                <div class="inputContainer">
                    ...
                    <div class="inputGroup">
                        ...
                        <select name="cboBrandName">
                            <option style="color: #616161;">
                                <?php echo $rowBrand['BrandID']. " - " .$rowBrand['BrandName']; ?></option>
                            <?php
                    ...
                    <div class="inputGroup">
                        ...
                        <select name="cboCategoryName">
                            <option><?php echo $rowCat['CategoryID']. " - " .$rowCat['CategoryName']; ?></option>
                            <?php
                    ...
                    <div class="inputGroup">
                        ...
                        <input type="date" name="txtMD" value="<?php echo date('Y-m-d', strtotime($dMD)); ?>">
                    ...
                    <div class="inputGroup">
                        ...
                        <input type="date" name="txtED" value="<?php echo date('Y-m-d', strtotime($dED)); ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Quantity <span style="color: red;">*</span></label> <br>
                        <input type="number" name="txtQty" value="<?php echo $dQty ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Price (Purchase Price) <span style="color: red;">*</span></label> <br>
                        <input type="number" name="txtPPrice" value="<?php echo $dPPrice ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Price (Sell Price) <span style="color: red;">*</span></label> <br>
                        <input type="number" name="txtSPrice" value="<?php echo $dSPrice ?>">
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
                        <label for="">Description <span style="color: red;">*</span></label> <br>
                        <textarea name="txtDescription"><?php echo $dDescription ?></textarea>
                        <br><br>
                    </div>
                    <br>
                    <div class="inputGroup">
                    ...
                    if ($dProductStatus == "Active") {
                        ...
                        echo   "<input type='radio' name='rdoStatus' value='Popular'>Popular";
                        echo   "<input type='radio' name='rdoStatus' value='Promotion'>Promotion";
                    }
                    elseif ($dProductStatus == "Inactive") {
                    ...
                    elseif ($dProductStatus == "Popular") {
                        echo   "<input type='radio' name='rdoStatus' value='Active'>Active";
                        echo   "<input type='radio' name='rdoStatus' value='Inactive'>Inactive";
                        echo   "<input type='radio' name='rdoStatus' value='Popular'checked>Popular";
                        echo   "<input type='radio' name='rdoStatus' value='Promotion'>Promotion";
                    }
                    else {
                        echo   "<input type='radio' name='rdoStatus' value='Active'>Active";
                        echo   "<input type='radio' name='rdoStatus' value='Inactive'  >Inactive";
                        echo   "<input type='radio' name='rdoStatus' value='Popular' >Popular";
                        echo   "<input type='radio' name='rdoStatus' value='Promotion'checked >Promotion";
                    }
                ?>
                    </div>
                    <br><br>
                    <input type="hidden" name="txtProductID" value="<?php echo $dproductID ?>" /><br><br>
